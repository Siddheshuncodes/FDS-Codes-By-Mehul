...
def freq():
    ...
    freq = 0
    count = 0
    initial = 0 #initial will be equal to initial value of i from the loop


    for i in range(len(mark_list)):
       freq = mark_list.count(mark_list[i])
       if freq>count:
          count=freq
          initial = i
    print("The Highest frequency of",mark_list[initial], "is: ",count)  
